...
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_fp_sum3.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_fp_sub.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_fp_addsub.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_ifp_fp_conv.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_ifp_addsub.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_fp_ifp_conv.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_fp_mac.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_fp_dp2.v"
// `include "/cad/synopsys/synthesis/2022.03/dw/sim_ver/DW_ifp_mult.v"
module PATTERN(
           // Output signals
           clk,
           rst_n,
...
initial
begin
    pat_file = $fopen("/home/lab911_1/Desktop/7112064132/Iclab_2021_Fall/ICLAB_04/pat.txt", "r");
    a = $fscanf(pat_file, "%d\n", PATNUM);
    ...
    begin
        ...
        for( epoch=0 ; epoch<25 ; epoch=epoch+1 )
        begin
...
task check_out_task ;
    begin
        ...
        begin
            ...
            begin
                if (golden_out[k]==1)
                    golden_out_exponent = golden_out_exponent + aa ;
                aa = aa * 2 ;
            end
            ...
            begin
                if (golden_out[k]==1)
                    golden_out_fraction = golden_out_fraction + aa ;
                aa = aa / 2 ;
            end
